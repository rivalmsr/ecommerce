<?php /* /home/rivalmsr/Documents/rdeveloper/laravel/ecommerce-adminLTE/resources/views/layouts/core.blade.php */ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <nav class="main-header navbar navbar-expand bg-info navbar-light border-bottom">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo e(route('products.index')); ?>" class="nav-link">Home</a>
      </li>
      <!-- Cart -->
      <li class="nav-item">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a class="nav-link" href="<?php echo e(route('admin.orders.index')); ?>">Order</a>
      <?php endif; ?>
    </ul>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('admin.products.index')); ?>" class="nav-link active">

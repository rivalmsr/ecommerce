<?php /* /home/rivalmsr/Documents/rdeveloper/laravel/ecommerce/resources/views/admin/products/create2.blade.php */ ?>
        ...
        <div class="col">
          ...
          <form action="<?php echo e(route('admin.products.store')); ?>" method="post">
            ...
            <div class="form-group">
              ...
              <textarea name="description" class="form-control" id="ckview" rows="3" placeholder="Deskripsi" required></textarea>
            </div>
